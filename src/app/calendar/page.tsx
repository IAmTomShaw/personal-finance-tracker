      ...
      <ClientOnly>
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-neutral-100 mb-2">Finance Calendar</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-neutral-800 rounded-lg shadow dark:shadow-neutral-900/50 p-4 text-center">
              <p className="text-xs font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wider">Monthly Income</p>
              <p className="text-base sm:text-lg font-bold text-green-600 dark:text-green-500 mt-1">
                {formatCurrency(monthlySummary.income)}
              </p>
            </div>
            <div className="bg-white dark:bg-neutral-800 rounded-lg shadow dark:shadow-neutral-900/50 p-4 text-center">
              <p className="text-xs font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wider">Monthly Expenses</p>
              <p className="text-base sm:text-lg font-bold text-red-600 dark:text-red-500 mt-1">
                {formatCurrency(monthlySummary.expenses)}
              </p>
            </div>
            <div className="bg-white dark:bg-neutral-800 rounded-lg shadow dark:shadow-neutral-900/50 p-4 text-center">
              <p className="text-xs font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wider">Net</p>
              <p className={`text-base sm:text-lg font-bold mt-1 ${monthlySummary.net >= 0 ? 'text-green-600 dark:text-green-500' : 'text-red-600 dark:text-red-500'}`}>
          ...
          {deleteConfirmId && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-sm px-4">
              <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-xl dark:shadow-neutral-900/50 w-full max-w-sm p-6">
                <h3 className="text-lg font-bold text-gray-900 dark:text-neutral-100 mb-2">Delete Transaction</h3>
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-md bg-red-600 text-white hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700"
                  >
                    Delete
                  </button>
                </div>
